"""
Django settings for school_project_back project.
...
SECRET_KEY = 'django-insecure-ty6bl9uk(g%^9=zw(&d@z!58n$*t=czc8@5%9i-(ik7xl=g#7*'
...
WSGI_APPLICATION = 'school_project_back.wsgi.application'
